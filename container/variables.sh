...
DTRK_APIS_PORT_BEF=8080
DTRK_APIS_PORT_AFT=8980
DTRK_FRNT_PORT_BEF=8081
DTRK_FRNT_PORT_AFT=8981
DTRK_ADMIN_USER="admin"
DTRK_ADMIN_PASS="password"
DTRK_HOST_API="localhost:${DTRK_APIS_PORT_AFT}"
